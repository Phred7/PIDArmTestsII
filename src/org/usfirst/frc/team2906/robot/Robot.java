...
public class Robot extends IterativeRobot {
	...
	public void autonomousPeriodic() {
		Scheduler.getInstance().run();
		//SmartDashboard.putNumber("ArmCoder", (((RobotMap.armCoder.get())*(RobotMap.distancePerPulse))/(1000)));
	}
	...
	public void teleopPeriodic() {
		Scheduler.getInstance().run();
		//SmartDashboard.putNumber("encodering", RobotMap.armCoder.get());
		//SmartDashboard.putNumber("ArmCoder", RobotMap.encoderDegs);
		//SmartDashboard.putNumber("ArmCoder", (RobotMap.armCoder.get()));
		//SmartDashboard.putNumber("ArmCoder", (((RobotMap.armCoder.get())*(RobotMap.distancePerPulse))/(1)));
	}
